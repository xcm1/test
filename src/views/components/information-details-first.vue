  ...
  <div>
      ...
      <table class="customTable">
        <tbody>
          ...
          <tr>
            ...
            <td colspan="2">教授（正高）</td>
          </tr>
          <tr>
            <td><div class="title">专业类别</div></td>
            <td colspan="2">管理类 中小学教育</td>
            <td><div class="title">编制情况</div></td>
            <td colspan="2">教师编制</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan="3">804479200409157158</td>
            <td><div class="title">邮箱地址</div></td>
            <td colspan="2">n3--2@pixso.cn</td>
          </tr>
          <tr>
            <td><div class="title">工作单位及职务</div></td>
            <td colspan="3">上海市师资培训中心</td>
            <td><div class="title">手机号码</div></td>
            <td colspan="2">14767232383 </td>
          </tr>
          <tr>
            <td><div class="title">通讯地址</div></td>
            <td colspan="3">湖南省张家界市永定区后坪镇396号105室</td>
            <td><div class="title">邮政编码</div></td>
            <td colspan="2">121287</td>
          </tr>
          <!-- <tr>
            <td colspan="2"><div class="title">督学资格证书编号</div></td>
            <td colspan="3">202207024</td>
          ...
          <tr>
            ...
            <td colspan="6">
              <div class="td-text-left">
                <p style="color:red">提示：区级审核意见必须填写曾经参加过的活动，以及负责人签名和日期，最终需要下载表格并盖章。</p>
                <div class="template-wrap">
                  <div><el-link type="primary" style="font-size:14px" @click="viewTemplate"><i class="el-icon-info" /> 点击查看初审意见模板</el-link></div>
                  <div><el-button size="mini" @click="useTemplate">使用模板</el-button></div>
                </div>
                <div>
                  <tinymce ref="tinymce" v-model="content" :height="220" />
                </div>
              </div>
            </td>
          </tr>
    ...
    >
      ...
      <!-- <div slot="footer" class="dialog-footer" style="text-align:center">
        <el-button type="primary" icon="el-icon-download" @click="dialogVisibleTemplate = true">下载本页</el-button>
        <el-button type="primary" icon="el-icon-printer" @click="dialogVisibleTemplate = true">打印</el-button>
      </div> -->
    </el-dialog>
  </div>
</template>
  ...
  data() {
    return {
      ...
      `<p>1.曾参加的教育督导活动（时间、地点、督导活动名称）</p>
                ...
                <p> 2.是否同意申报：同意</p>
                <div style="padding-left: 300px;">（单位盖章）负责人签名：夏长来<br>
                  <p style="padding-left: 80px">2021 年5月6日</p></div>`,
      info: '',
      dialogVisibleTemplate: false,
      imageUrl: require('@/assets/images/photo.png'),
      qrcodeUrl: require('@/assets/images/qrcode.png'),
      lookUrl: require('@/assets/images/look.jpg')
    }
  },
  methods: {
    viewTemplate() {
    ...
    useTemplate() {
      ...
      this.$refs.tinymce.setContent(this.contentTemplate)
    }
  }
}
</script>
